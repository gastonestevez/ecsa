...
<head>
    ...
    <script src="https://kit.fontawesome.com/c9d2de6379.js" crossorigin="anonymous"></script>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-185926981-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-185926981-1');
</script>
<!-- Google Tag Manager -->
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    })(window,document,'script','dataLayer','GTM-M5G3CBX');</script>
    ...
    <footer>
        <div class='footer container'>
            <div class="contactItem">
                ...
                <p class="text">Llavallol 2987 CABA</p>
            </div>
            <div class="contactItem">
                <div class="title-box">
        ...
        <div class="develop__box">
            <p class="develop"> 
                <a target='_blank' href="https://www.dakotadevelopers.com/">
                Desarrollado por Dakota Developers
                </a> 
            </p>
